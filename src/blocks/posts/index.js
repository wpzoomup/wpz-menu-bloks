...
const name = 'wpz-menu-blocks/posts';
const title = __( 'Multiple Posts', 'wpz-menu-blocks' );
...
registerBlockType( name, {
	title: `${ title } (WPZ Menu Blocks)`,

	description: __( 'Display multiple posts.', 'wpz-menu-blocks' ),

	keywords: [
		'multiple posts',
		__( 'multiple posts', 'wpz-menu-blocks' ),
	],
